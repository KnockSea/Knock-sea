...
const NsMain = ({ shipList, spotList, eduList, linkdetail }) => {
  return (
    <section>
      <ScrollToTop />
      <Routes>
        ...
        <Route path="/detail/:productId" element={<RvBtDetail />}>
          {" "}
        </Route>
        <Route path="/fsdetail/:productId" element={<RvFsDetail />}>
          {" "}
        </Route>
        {/* 클래스 탭 */}
...
const MainContent = ({ shipList, spotList, eduList, linkdetail }) => {
  return (
    <>
      {
        <>
          ...
          <div className="mainbox">
            <div className="contentbox">
              <NsItem shipList={shipList} linkdetail={linkdetail} />
              <NsFishingSpot spotList={spotList} linkdetail={linkdetail} />
