    ...
    return (
        <section>
            ...
            <Routes>
                ...
                {/* 배낚시 탭 */}
                <Route path="/detail" element={<RvBtDetail />}>
                    {" "}
                </Route>
                {/* 낚시터 탭 */}
                <Route path="/fsdetail" element={<RvFsDetail />}>
                    {" "}
                </Route>
                {/* 클래스 탭 */}
                <Route path="/class" element={<ClassMain />}></Route>
                <Route
                    path="/classdetail/:eduId"
                    element={<ClassDetail />}
                ></Route>
                {/* 마이페이지 */}
                ...
                {/* 문의 상세보기 */}
                <Route
                    path="/inquiryResult/:inquiryId"
                    element={<MpInquiryResult />}
                ></Route>
