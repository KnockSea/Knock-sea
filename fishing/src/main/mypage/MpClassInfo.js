      ...
      <div className="mainbox1">
        ...
        <div className="userinfobox">
          ...
          <div className="namebox">
            {myEdu && myEdu.eduTitle ? (
              <div className="nickName">{myEdu.eduTitle}</div>
            ) : (
              <div className="nickName">등록된 클래스가없습니다!</div>
            )}
            {myEdu && myEdu.Description ? (
              <div>{myEdu.Description}</div>
            ) : (
              <div>클래스 정보를 등록해주세요!</div>
            )}
          </div>
          <div className="btbox">
