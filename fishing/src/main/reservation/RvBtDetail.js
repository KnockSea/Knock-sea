        ...
        <div className="left">
          ...
          <div className="text1">
            ...
            <mark className="t1">
              ...
              주민등록등본(실물), 사진 안됩니다! <br />
            </mark>{" "}
            <mark>
              @ 선상음주 금지(300 만원 이하의 과태료) <br />
          ...
          <div className="textboxs">
            <div className="rvtext">
              ...
              <div className="rv_t1">
                선박출조 예약시 승선료를 선입금 해 주셔야 예약이
                완료됩니다.미입금시 가예약 처리됩니다. <br />
                물때(조석) 와 시기, 출조기, 승선인원에 따라 가격이 변동될 수
                있습니다. <br />
                별도 문의바랍니다.{" "}
              </div>{" "}
            </div>{" "}
            ...
            <div className="paytext">
              ...
              <div className="pay_t1">
                ...
                <br />
                <mark>
                  @출항 2 주일전 취소는 90 % 환불 <br />
                  @출항 4~13 일 전 취소는 70 % 환불 <br />
                  @출항 3~4 일전 취소는 50 % 환불 / 날짜 변경불가 <br />
                  @출항 3 일전 날짜 환불불가 / 날짜 변경불과{" "}
                </mark>{" "}
                <br />
                <br />
                <mark>
                  @기상악화, 배 고장으로 인한 출조 취소는, 선비만 환불
                  해드립니다. <br />
                  @신분증 미 소지자는 승선 하실수 없으며, 선비도 전액 환불이
                  되지 않습니다. <br />
                  @선상에서 선장의 지시를 따르지 않을때 승선을 거부 할 권리가
                  있습니다.그로 인 한 선비도 환불도 하지 않습니다. <br />
                  @출항 취소나 배 고장으로 인한 조기 입항시, 교통비, 숙박비는
                  본인이 하신것 이기에 선사나 선장이 보상해주지 않습니다.{" "}
                </mark>{" "}
                <br /> <br />
                <p>
                  {" "}
            ...
            <div className="dgtext">
              ...
              <div className="dg_t1">
                즐거운 바다낚시를 위하여 선상질서와 낚시예절은 꼭!지켜주시고{" "}
                <br />
                환경보호와 어족자원을 보호하기위해 납봉 사용은 불허하고
                있습니다. <br />
                조사님 여러분의 동참과 협조를 부탁드립니다. <br />
                출항하실때에는 낚시대가 옆배와 부딪혀 파손될 우려가 있으니
                철저한 주의와 관리를 당부 드립니다. <br />
                또한 선상에서 분실되는 물건이 간혹 발생하오니 철저한 주의와
                관리를 부탁드립니다. <br />
                위와 같은 불미스러운 경우가 발생할 경우 개인 과실임을
                알려드립니다.
              </div>{" "}
            </div>{" "}
          </div>{" "}
